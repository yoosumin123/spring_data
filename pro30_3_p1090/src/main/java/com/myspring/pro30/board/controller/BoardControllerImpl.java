...
public class BoardControllerImpl implements BoardController {
	 ...
	 * String viewName = (String)request.getAttribute("viewName"); // url 주소 입력 ->
	 * 인터셉터로 불러옴 articleVO=boardService.viewArticle(articleNO); // service에 있는
	 * viewArtilce 불러와라 ModelAndView mav = new ModelAndView();
